			...
			<form onSubmit={this.onSubmit}>
				<div className="grid gap-6 mb-6 md:grid-cols-2">
					...
					<div>
						...
						value={this.state.date} onChange={this.onChange} max={today}/>
						<p id="date" className="mt-2 text-sm text-gray-500 dark:text-gray-400">Selecione o dia e o horário que realizou o exercício</p>
					</div>
				</div>
				<button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registrar Métricas</button>
			</form>
		);
	}
}
